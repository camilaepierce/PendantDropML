...
if __name__ == "__main__":
    ...
    ### Choose model type             
    model = Empty() #NOTE this line NEVER gets deleted, only changed
    ...
    model.load_state_dict(torch.load('model_weights/EmptyTestingLarge.pth', weights_only=True))
    ...
    optimize_hyperparams(Empty, config)
